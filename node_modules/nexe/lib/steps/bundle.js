        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 7:
                    _e.sent();
                    return [2 /*return*/, next()];
                case 8: return [4 /*yield*/, resolve_dependencies_1.default(input, { cwd: cwd, expand: true, loadContent: false })];
                case 9:
                    _d = _e.sent(), files = _d.files, warnings = _d.warnings;
                    if (warnings.filter(function (x) { return !x.startsWith("Can't resolve"); }).length) {
